...
\itemB Proof of Lemma:
\begin{enumerate}
\itemb in the General case: Consider the automorphism $\phi$ from the general case of the Lemma. Show that for a monomial, we have $\phi(a X_1^{d_1} \cdots X_n^{d_n})$ is a polynomial with unique highest degree term $a X_n^{d_1 D^{n-1} + d_2 D^{n-2} + \cdots + d_n}$. Can two monomials $\mu,\nu$ in $F$, have $\phi(\mu)$ and $\phi(\nu)$ with the same highest degree term? Complete the proof.
\itemb Prove the Lemma in the infinite field case.
\end{enumerate}
