...
\itemB Prove the principle of \textbf{Noetherian induction}: Let $\mathcal{P}$ be a property of a ring. Suppose that ``For every nonzero ideal $I$, $\mathcal{P}$ is true for $R/I$  implies that $\mathcal{P}$ is true for $R$''. Then $\mathcal{P}$ is true for every Noetherian ring.
