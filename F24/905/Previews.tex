...
\noindent \textsc{Corollary:} Let $R$ be a ring, $I$ an ideal, and $W$ a multiplicatively closed subset. Then the map $R\mapsto W^{-1}(R/I)$ induces an order preserving bijection
\[ \Spec(W^{-1}(R/I)) \stackrel{\sim}{\longrightarrow} \{ \p\in \Spec(R) \ | \ \p \supseteq I \ \text{and} \ \p \cap W=\varnothing\}.\]

\newpage

 \subsection{Local Properties: Lecture Notes Section \S5.2, \S6.1}\0
