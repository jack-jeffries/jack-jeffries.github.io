...
\subsection{Rings} Grifo \S0.1; Atyiah-MacDonald \S1
...
\subsection{Ideals} Grifo \S0.1; Atyiah-MacDonald \S1
...
\subsection{Algebras} Grifo \S1.2; Aityah-MacDonald \S2
...
\subsection*{1.m \, \, Macaulay2 Introduction} Grifo \S A.1
...
\item Ideals: With $R$ as above, try \verb|I=(X^2,X*Y)| \ or  \ \verb|J=(X^3-2*X^2*Y+7*Y^5)|
...
\subsection{Modules} Grifo \S1.1, Atiyah-MacDonald \S2
...
\subsection{Algebra-finite and module-finite maps} Grifo \S1.3, \S1.4, Atiyah-MacDonald \S2
...
\newpage
\subsection{Integral extensions} Grifo \S1.4, Atiyah-MacDonald \S5
...
\newpage
\subsection{Noetherian rings} Grifo \S1.6, Atiyah-MacDonald \S6, \S7
...
\newpage
\subsection{Noetherian modules} Grifo \S1.6, Atiyah-MacDonald \S6, \S7
...
\subsection{Graded rings} Grifo \S2.1
