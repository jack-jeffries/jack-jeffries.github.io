...
%	 \item If $f$ is continuous at $2$ and $\lim\limits_{x\to 1} g(x) =2$, then $\lim\limits_{x\to 1} f(g(x)) = f(2)$.
...
%	 \item If $f$ is continuous at $2$ and $\lim\limits_{x\to f(2)} g(x) =3$, then $\lim\limits_{x\to 2} g(f(x)) = 3$.
