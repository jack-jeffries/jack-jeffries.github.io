...
\[ R^{\oplus \Gamma} \xra {A\cdot} R^{\oplus \Lambda} \to N \to 0\]
be a presentation of a module $M$. Then there is a right exact sequence
\[ M^{\oplus \Gamma} \xra {A\cdot} M^{\oplus \Lambda} \to M \otimes_R N \to 0.\qedhere\]
\end{cor}
