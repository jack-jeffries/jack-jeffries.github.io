...
\begin{defn} We say that two complexes $P_\bullet, Q_\bullet$ are \DEF{homotopy equivalent} if there are maps $f:P_\bullet \to Q_\bullet$ and $g:Q_\bullet \to P_\bullet$ such that $fg \htpy 1_{Q_\bullet}$ and $gf \htpy 1_{P_\bullet}$.
\end{defn}

\begin{cor} Any two projective resolutions for a fixed module $M$ are homotopy equivalent.
\end{cor}
