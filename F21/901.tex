...
I claim that the endomorphism ring of $M_3$ is just $\R$. It contains $\R$ as a subring, given by the scaling operators (see the Proposition below).
...
As before we start by finding 1-dimensional representations given by group homomorphisms of the form $A_4 \to \C^\times$. Any such map factors as
  $$
A_4 \onto A_4^{ab}\cong C_3 \to \C^\times
  $$
...
$$
It is easy to see there is only one solution $m=4$ and $n_4=3$.  Hence there is a unique up to isomorphism $\C$-linear irreducible representation of $A_4$ which is a 3 dimensional $\C$-vector space. We give an example of such a representation: let $A_4$ act on $V=\C^4$ by permuting the standard basis elements and thus the coordinates of any vector in $V$. We see that the vector subspace 
\[
W=\{(a,a,a,a) \mid a\in \C \} \cong \C
\]
is invariant under this action, hence a subrepresentation of $V$. It follows that the quotient vector space $V/W$ is also a $\C$-linear representation of $A_4$ and $\dim_\C(V/W)=3$.
