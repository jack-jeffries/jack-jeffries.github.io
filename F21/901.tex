...
\begin{ex} Let's compute $\Ext^*_\Z(\Z/m, \Z/n)^I$ and $\Ext^*_\Z(\Z/m, \Z/n)^{II}$.
    ...
    For the latter, we start with the free resolution $\cdots 0 \to \Z \xra{m} \Z (\to \Z/m\Z) \to 0$ of $\Z/m$ and apply $\Hom_\Z(-, \Z/n)$ to obtain
    $$
    \cdots \leftarrow 0 \leftarrow \Hom_\Z(\Z, \Z/n\Z) \xleftarrow{m}\Hom_\Z(\Z, \Z/n\Z) \leftarrow 0
    $$
    which is isomorphic to
    $$
    \cdots \leftarrow  0 \leftarrow  \Z/n \xleftarrow{m}  \Z/n \leftarrow  0.
    $$
