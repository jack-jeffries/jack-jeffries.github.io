...
\item Facts about $p$-bases/ $p$-degree:
 \begin{enumerate}
\item Let $K \subseteq L$ be an extension of fields of positive characteristic. 
Let $T$ be a $p$-basis for $L$ over $K$. Show that for any $e$, the set $T^{[<p^e]}$ is a basis for $L$ over $K(L^{p^e})$.
