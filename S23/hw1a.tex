...
\begin{enumerate}
\item Show that $\fm^t$ consists of the functions $f\in \R$ such that $\frac{d}{x_1}^{a_1} \cdots \frac{d}{x_n}^{a_n} (f)|_{x=x_0} = 0$ for all $a_1,\dots,a_n$ with $a_1+\cdots+a_n<t$.
