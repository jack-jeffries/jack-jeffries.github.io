...
\item Let $R$ be a ring and $M$ an $R$-module. Recall that $R\rtimes M$ denotes the Nagata idealization of $M$: the ring with additive structure $R\oplus M$ and multiplication $(r,m)(s,n) = (rs,rn+sm)$. Show that $\alpha:R\to M$ is a derivation if and only if $(1,\alpha):R\to R\otimes M$ ($r\mapsto (r,\alpha(r))$) is a ring homomorphism.
