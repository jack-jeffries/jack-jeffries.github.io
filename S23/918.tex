...
\begin{thm}
 ...
 \end{thm}
 \begin{proof}[Sketch:] There is an analogue of the second fundamental sequence + universal perivation modules localize.
 \end{proof}
