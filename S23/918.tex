...
\end{proof}
 ...
 \end{prop}
 \begin{proof}
 Since $\phi$ is continuous, a continuous homomorphism maps a Cauchy sequence to a Cauchy sequence, and a sequence converging to zero to one converging to zero. Thus, the map $\hat{\phi}( (r_n)  ) = (\phi(r_n))$\dots
