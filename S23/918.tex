...
\begin{exer} Let $A \xra{\phi} R$ be a ring homomorphism. If for any finite subset $r_1,\dots,r_n\in R$, the map $A\to A[r_1,\dots,r_n]$ is formally unramified/smooth/\'etale, then so is $\phi$.
\end{exer}
