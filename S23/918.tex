...
\[ \Der_{R|A}(M) \xra{\res} \Hom_R(I/I^2,M)\]
is surjective.
\end{prop}
\begin{proof}
...
\end{prop}
\begin{proof}
Take a presentation of $T$ as an $R$-algebra, and take the presentation as an $R$-module obtained from it as discussed above (namely, generators given by monomials, and relations given by taking coefficients of the multiples of the relations by different monomials). Applying algebra extension of scalars to $T$, and taking the corresponding module presentation gives the same presentation module presentation.
\end{proof}
...
To compute modules of differentials in general, we will bootstrap off of this case. To get started, we will need to 
