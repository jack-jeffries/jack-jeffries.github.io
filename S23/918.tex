...
We claim that $L_i[x_i^2,x_i^3]_{(x_i^2,x_i^3)}\cong S_{\fp_i}$. Indeed, from above we can identify $L_i[x_i^2,x_i^3]$ and hence $L_i[x_i^2,x_i^3]_{(x_i^2,x_i^3)}$ with subsets of $\mathrm{frac}(S)$. Unpackaging the definitions, one sees that $L_i[x_i^2,x_i^3]_{(x_i^2,x_i^3)}$ coincides with the subset of $\mathrm{frac}(S)$ identified above, so $R_{\fp_i R}\cong L_i[x_i^2,x_i^3]_{(x_i^2,x_i^3)}$.
