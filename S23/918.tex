...
Note that a local ring can have a coefficient field only if it has equal characteristic, and that the map from any subfield to the residue field is always injective.
