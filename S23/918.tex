...
\begin{thm}
 ...
 \begin{thm}
 Let $S=\Z[x_1,\dots,x_n]$. Let $R=S/I$, with $I=(f_1,\dots,f_t)$, let $\fp$ be a prime ideal of $R$ containing $p$, and $\fq$ the preimage of $\fp$ in $S$. The following are equivalent:
 \begin{enumerate}
 \item $R_\fp$ is regular
