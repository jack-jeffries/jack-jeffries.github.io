...
\begin{problem}
	Let $F \subseteq L$ be a field extension and let $S \subseteq L$ be an arbitrary subset of $L$ whose elements are all algebraic over $F$. Show that $F \subseteq F(S)$ is algebraic.
\end{problem}
