...
\begin{problem} Brush up on Gauss' Lemma, and read the short Section 10.2 from the Math 817 lecture notes, on Eisenstein's Criterion. Then
 \begin{enumerate}
\item[(a)] Prove that the polynomial $x^2 + y^2 -1$ is irreducible in $\Q[x,y]$.
  \item[(b)] Prove\footnote{Hint: Think modulo $2$.} that $5x^4 + 7x^3 + 11x^2 +6x + 1$ is irreducible in $\Q[x]$.
