...
$
\begin{pmatrix}x&1&0\\1&x&-3\\0&0&x-1\end{pmatrix}
\stackrel{(1)}{\ra}
\begin{pmatrix}1&x&0\\x&1&-3\\0&0&x-1\end{pmatrix}
\stackrel{(2)}{\ra}
\begin{pmatrix}1&0&0\\x&-x^2+1&-3\\0&0&x-1\end{pmatrix}
$

$
\stackrel{(3)}{\ra}
\begin{pmatrix}1&0&0\\0&-x^2+1&-3\\0&0&x-1\end{pmatrix}
\stackrel{(4)}{\ra}
\begin{pmatrix}1&0&0\\0&-3&-x^2+1\\0&x-1&0\end{pmatrix}
$

$
\stackrel{(5)}{\ra}
\begin{pmatrix}1&0&0\\0&-3&0\\0&x-1&-\frac{1}{3}(x^2-1)(x-1)\end{pmatrix}
\stackrel{(6)}{\ra}
\begin{pmatrix}1&0&0\\0&-3&0\\0&0&-\frac{1}{3}(x^2-1)(x-1)\end{pmatrix}$

$\stackrel{(7)}{\ra}
\begin{pmatrix}1&0&0\\0&1&0\\0&0&(x^2-1)(x-1)\end{pmatrix}$,

where 

(1) is a permutation swapping columns 1 and 2,\\
(2) adds $-x$ times column 1 to column 2,\\
(3) adds $-x$ times row 1 to row 2,\\
(4) is a permutation swapping columns 2 and 3,\\
(5) adds $-\frac{1}{3}(x^2-1)$ times column 2 to column 3,\\
(6) adds $-\frac{1}{3}(-x+1)$ times row 2 to row 3,\\
(7) multiplies row 2 by the unit $-\frac{1}{3}$ in $\R$ and multiplies row 3 by the unit $-3$ in $\R$.
\end{proof}
...
\begin{proof}[Solution]
Since the unique invariant factor of $A$ is $(x^2-1)(x-1)$ from the SNF, 
 the invariant factor decomposition of the $\R[x]$-module
presented by $A$ is $$\R[x]/((x^2-1)(x-1)).$$

The elementary divisor decomposition is obtained from the above by using the CRT. It is the last module in the following isomorphism
$$\R[x]/((x^2-1)(x-1))=\R[x]/((x+1)(x-1)^2)\cong \R[x]/(x+1)\oplus \R[x]/((x-1)^2).\qedhere$$
\end{proof}
\end{problem}
