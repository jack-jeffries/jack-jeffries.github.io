...
\
	...
	\itema Carefully explain why neither $\sqrt[3]{2}$ nor $\sqrt[4]{2}$ can be computed exactly with a dollar store calculator using the $\surd$ key \emph{only once} (at any point, not necessarily at the end).
