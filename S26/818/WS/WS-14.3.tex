...
\begin{enumerate}
	\itema Let $A$ and $B$ be two $3 \times 3$ matrices with entries in $F$. Prove $A$ and $B$ are similar if and only if they have the same characteristic polynomial and the same minimal polynomial.
