...
\itemA Remember/state the Structure Theorem for Finitely Generated Abelian Groups (Invariant Factor Form), and deduce it from the PID Theorem.
...
\itemB Let $R$ be a Euclidean domain. Use the Smith Normal Form Theorem to deduce\footnote{Hint: Suppose that $D$ is diagonal and invertible. What can you say about the diagonal entries of $D$?} that any invertible matrix over $R$ is a product of elementary matrices.
