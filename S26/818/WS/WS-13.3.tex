...
\itemA Prove\footnote{Hint: In HW\#4, you proved that $I_t(PAQ)=I_t(A)$ for invertible matrices $P,Q$.} the uniqueness part (ii) of Smith Normal Form Theorem.
...
\textsc{Definition:} Let $R$ be a domain and $M$ be an $R$-module. We say that $M$ is \textbf{torsionfree} if for $r\in R$ and $m\in M$, we have $rm=0$ implies $r=0$ or $m=0$.
 ...
 \itema Show that any submodule of a finitely generated free $R$-module is free.
 \itema Prove or disprove: any torsionfree $R$-module is free.
 \itemb Prove or disprove: any submodule of a free $R$-module is free.
 \end{enumerate}
 \end{enumerate}
