...
\itema Use part (a) to show that if $R=F$ is a field, and $A$ is not invertible, then $\det(A)=0$.
...
\itemA Use the Proposition (and not the definition) to compute $\mathrm{det} \begin{bmatrix} 1 & 2 & 3 \\ 2 & 5 & 8 \\ 3 & 7 & 13 \end{bmatrix} \in \mathrm{Mat}_{3\times 3}(\Z)$.
