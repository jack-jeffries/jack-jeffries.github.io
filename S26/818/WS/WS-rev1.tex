...
\item We claim that $\ker(t_{AQ}) = t_{Q^{-1}} (\ker(t_A))$. Indeed, if $v\in \ker(t_{AQ})$, then $AQv=0$, so $Qv\in \ker(t_A)$, and hence $t_{Q^{-1}}(v) \in \ker(t_A)$. The reverse containment is similar.
