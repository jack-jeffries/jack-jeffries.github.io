...
The point is that there is no disjointness condition. In $\R^n$ with its Euclidean topology, the only irreducible subspaces are points. However, over an infinite field, $\A^1_K$ is irreducible!
