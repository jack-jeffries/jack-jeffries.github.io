...
%\end{proof}
 ...
 \begin{ex}
 Here is an example which shows that  the inequality $\dim(R/I) + \mathrm{height}(I) \leq \dim(R)$ in part 6 of Proposition \ref{rk:dimprop} can fail to be an equality.
