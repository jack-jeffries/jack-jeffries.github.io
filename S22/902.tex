...
\end{lem}
\begin{proof}
We just need to show that the $x^N$ coefficient is nonzero for some choice of $a$'s. You can check that the coefficient of the $x^N$ term is $f(-a_1,\dots,-a_{n-1},1)$. But if this, thought of as a polynomial in the $a$'s, is identically zero, then $f$ must be the zero polynomial.
\end{proof}
