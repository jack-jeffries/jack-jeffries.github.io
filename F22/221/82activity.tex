...
\[ \begin{cases} x' = \frac{1}{4} x - \frac{1}{4} y \\ y' = \frac{1}{2} x - \frac{1}{4} y\end{cases}.\]


\

First use the coins to do an experiment to test what happens with the linear system starting with $x=10$ and $y=10$.
