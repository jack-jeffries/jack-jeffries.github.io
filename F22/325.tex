...
\[\lim_{x\to r} \frac{ f(x) - f(r) }{x - r} = \lim_{x\to r} \frac{c - c} {x - r} = \lim_{x \to r} 0 = 0.\]
 \end{framed}
 ...
 \item Use the definition to show that the function $f(x) = 2x-5$ is differentiable at $x=3$ and compute its derivative. 
  ...
  \begin{framed}
Consider
\[\lim_{x\to r} \frac{ f(x) - f(r) }{x - r} = \lim_{x\to r} \frac{2x-5 - (2r-5) }{x - r} =  \lim_{x\to r} \frac{2(x-r)}{x - r} = \lim_{x\to r} 2 = 2.\]
 \end{framed}
