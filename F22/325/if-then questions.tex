...
\begin{enumerate}
\item For each of the following statements, write its contrapositive and its converse. Is the original/contrapositive/converse true or false? Explain why (but don't prove them). For all of the statements below, $a,b$ are real numbers.
\begin{enumerate}
...
\item For all $x\in \R$ such that $x\neq 0$,  $x^2 >0$.
...
\item Prove that (2d) is true and (2e) is false. (You are free to use (\ref{1>0}) below in your proof, even if you didn't prove it.)
