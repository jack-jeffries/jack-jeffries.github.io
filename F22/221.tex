...
\item Since this is a linear nonhomogeneous equation, we know that our particular solution plus any supoerposition of our homogeneous solutions is also a solution. This means \ref{10e}, \ref{10g}, and \ref{10h} are solutions too.
...
\[ y = y_p + y_c\]
where $y_p$ is any \emph{particular solution}\index{particular solution} and $y_c$ is the general solution to the associated homogeneous ODE (which in turn we will express like the last formula), called the \emph{complementary solution}\index{complementary solution}.
...
Now we consider 
\[y'' - 3y' + 2y = e^{x}.\]
We saw earlier that $y=-xe^x$ is a solution. Using what we just proved baout the homogeneous solution, we conclude that
