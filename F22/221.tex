...
using the $u$-substitution $u=e^{1/x}$, $du= -1/x^2 e^{1/x}$.
Finally, we get
\[ y = -5 + C e^{-1/x}\]
...
More concretely, we fix a \emph{step size}\index{step size} $h$, which plays the role of our small change in $t$ that we called $\Delta t$. This should be a small positive number. (Though how small can be difficult to pin down.) 
...
Let's also try step size $h=\frac12$.
\[x_1 = \frac12 , \quad y_1 = 0+ (0+0^2) \frac12 = 0\]
\[x_2 = 1, \quad y_2 = 0+ \big(\frac12 +0^2\big) \frac12 = \frac12=0.5\]
\[x_3 = \frac32, \quad y_3 = \frac12+ \big(1 +\big(\frac12\big)^2\big) \frac12 = \frac98 =1.125\]
\[x_4 = 2, \quad y_4 = \frac98 + \big(\frac32 +\big(\frac98\big)^2\big) \frac12 = \frac{321}{128} \approx 2.5 \]

Note that the different step sizes gave very different answers for $y(2)$. In general, smaller step sizes give better approximations, but take longer to compute.
\end{ex}


\begin{ex} Use Euler's method with step size $h=0.5$ to approximate a solution to 
...
\[ \rsa t (\ln \frac{10}{11}) /10 = 25/33\]
\[ \rsa t = \frac{250}{33 \ln(\frac{10}{11})}.\]
\end{ex}
...
Let $S$ be a the amount of salt in the tank in grams and $t$ be time in minutes. First we note that the tank has $300 + 2t$ gallons of water after $t$ minutes. The rate of salt coming in is $5 \times 6 = 30$ grams per minute. The rate of salt going out is $3\times \frac{S}{300 + 2t} = \frac{3}{300 + 3t} S$. The differential equation modeling the situation is
\[ S' = 30 - \frac{3}{300 + 2t} S.\]
...
\[\rsa  (300 + 3t) S = \int 30(300+3t) \, dt = 9000 t + 45 t^2 + C\]
...
\subsection*{Nonlinear models (\S3.2)}

We explore some nonlinear first-order ODEs that commonly show up in mathematical models. As a matter of terminology, we say that a quantity is \emph{jointly proportional}\index{jointly proportional} to two other quantities if it is proportional to their product. The idea is that as either of the other two grows, that quantity grows.

\begin{ex} A simple model for the spread of a disease throughout a population assumes that the rate at which the disease spreads is jointly proportional to tthe number of people infected and the number of people not infected: if $I$ is the number of total infected people and $P$ is the total population (which we assume is constant), we have
\[ \frac{dI}{dt} = k I (P-I).\]
Supposing a disease spreads among a population of $4000$ people, find a general formula.
This equation is separable:
\[ \frac{dI}{I (4000-I)} = k \, dt.\]
To integrate the left-hand side, we need to recall another idea from Calc 2: partial fractions. Write
\[ \frac{1}{I(4000-I)} = \frac{a}{I} + \frac{b}{4000-I}.\]
Then
\[ 1 = (4000-I)a + Ib\]
\[ \rsa 1 = 4000a + I(b-a)\]
\[ b-a=0 \rsa a=b, \ a=1/4000,\]
so
\[  \frac{1}{I(4000-I)} = \frac{1/4000}{I} +  \frac{1/4000}{4000-I}.\]
Then
\[ \int \frac{dI}{I (4000-I)} = \int \frac{1}{4000} \frac{dI}{I} +  \int  \frac{1}{4000} \frac{dI}{4000-I}\] \[= \frac{1}{4000} \left(\ln|I| - \ln|4000-I|\right) = \frac{1}{4000} \ln \left| \frac{I}{4000-I} \right|.\]
We then have
\[ \frac{1}{4000} \ln \left| \frac{I}{4000-I} \right| = kt +C \]
\[ \ln \left| \frac{I}{4000-I} \right| = 4000 kt +C\]
\[ \frac{I}{4000-I}  = \pm e^{ 4000 kt +C}\]
\end{ex}
