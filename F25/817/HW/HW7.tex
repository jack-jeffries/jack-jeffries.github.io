...
\begin{problem}
Let $p$ be a prime number and $|G|=p^e$ for some $e\geq 1$. Show that for any nontrivial normal subgroup $N\trianglelefteq G$, we have $N \cap Z(G) \neq \{e\}$.
\end{problem}
...
\item[(b)] Show\footnote{Hint: Use a Theorem from class.} that there exists some $z\in X$ such that $g\cdot z\neq z$ for all $g\in G\smallsetminus \{e\}$.
\end{enumerate} 
\end{problem}
