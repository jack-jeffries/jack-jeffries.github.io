...
\itema Apply the induction hypothesis to $G/N$. How can you use this to find a Sylow $p$-subgroup back in $G$?
\itema Case 2: Assume that $p$ does not divide $|Z(G)|$. Show that there is some $g\in G$ such that $|C_G(g)|$ is \emph{not} a multiple of $p$ and \emph{not} one. What does this say about $|C_G(g)|$? What do you get from the induction hypothesis?
\end{enumerate}

\

\itemB Proof of parts (2) and (3) of Sylow's Theorem: Fix a Sylow $p$-subgroup $P$. Let $\mathcal{S}_P$ be the set of conjugates of $P$, namely  $\{ g P g^{-1} \ | \ g\in G\}$.
\begin{enumerate}
