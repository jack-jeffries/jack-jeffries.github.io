...
\showsol{0}
	...
	\section*{{\large Math 309 Fall 2026: Introduction to Mathematical Proofs}\\ MW 11:30am--12:20am, Avery Hall 112}
	...
	\
		...
		\subsection*{Course Description} The goal of this course is to provide a foundation in understanding and writing rigorous mathematical proofs. This will be achieved by an introduction to formal mathematical language which includes mathematical notation and quantifiers, working with different mathematical objects (sets, functions, relations), and learning about different types of proofs. Specifically, a successful student in this course will be able to:

\begin{itemize}
	\item Communicate effectively using the formal language of mathematics.
	\item Evaluate the validity of complex logic statements.
	\item Identify useful definitions and use them to make valid deductions.
	\item Recognize various mathematical proof techniques and know when to apply them.
	\item Comprehend and evaluate validity of mathematical proofs, and criticize invalid proofs.
	\item Write rigorous and concise mathematical proofs.
	\item Present and explain the reasoning behind mathematical proofs.
\end{itemize}
...
\begin{multicols}{2}
	...
	\item Elements of logic
	\item Types of proofs
	\item Induction
	\item Study of functions
...
\end{itemize}
	...
	\subsection*{Course Website} \href{https://jack-jeffries.github.io/F26/309.html}{https://jack-jeffries.github.io/F26/309.html}
...
This class will have regular written homework assignments and in-class quizzes and exams. There will also be a component for attendance/participation.

\subsection*{AI statement} 
 The purpose of this class is to train you to build a general proficiency for how to write and read proofs and asses their validity, and more generally how to apply these ideas to assess the validity of more informal arguments and use rigorous reasoning in general. Using AI tools to do your homework for you will deprive you of the opportunity to develop these skills; even worse, AI is still far from reliable in these regards.
 Accordingly, using AI tools to solve the homework is {not} allowed, and the use of any AI tools on assessments is strictly prohibited and constitutes a violation of the academic integrity policy. You are encouraged to use AI and other technological tools to generate more practice problems and examples, and to explore applications and examples of what we learn in other disciplines and real lift. I am happy to discuss any doubts you have about which uses of AI are permitted and which are not. 
...
\subsection*{Midterm and final exam} There will be two {midterms} and one {final exam}, all in-person. The midterms will take place from \textbf{5pm} to \textbf{7pm}, and the tentative midterm days are 
\begin{itemize}
\item October 7 (Wednesday)
\item November 18 (Wednesday)
\end{itemize}
%\noindent
The final exam will be 
{\bf Tuesday, December~15} from \textbf{10am} to \textbf{noon} in our usual classroom.
